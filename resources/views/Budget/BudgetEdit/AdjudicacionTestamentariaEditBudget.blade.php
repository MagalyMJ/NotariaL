...
@section('SpecialInputs') 
	...
	<input name="avaluo_catastral"  class="input medium" id="avaluo_catastral" type="checkbox" value="{{$Budget->case_service->service->findExpeseCostByName('Avalúo Catastral')}}" 
	...
	<input name="avaluo_comercial"  class="input medium" id="avaluo_comercial" type="checkbox" value="{{$Budget->case_service->service->findExpeseCostByName('Avalúo Comercial')}}" 
